...
/** 
 * DAO for table "IN_LINE".
*/
public class InLineDao extends AbstractDao<InLine, Long> {

    public static final String TABLENAME = "IN_LINE";

    /**
     * Properties of entity InLine.<br/>
    ...
    public static class Properties {
        ...
        public final static Property Homearea = new Property(15, String.class, "homearea", false, "HOMEAREA");
    }


    public InLineDao(DaoConfig config) {
        super(config);
    }
    
    public InLineDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"IN_LINE\" (" + //
                "\"ID\" INTEGER," + // 0: id
                ...
                "\"HOMEAREA\" TEXT);"); // 15: homearea
    }

    /** Drops the underlying database table. */
    public static void dropTable(Database db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"IN_LINE\"";
        db.execSQL(sql);
    }

    @Override
    protected final void bindValues(DatabaseStatement stmt, InLine entity) {
        stmt.clearBindings();
        ...
        if (homearea != null) {
            stmt.bindString(16, homearea);
        }
    }

    @Override
    protected final void bindValues(SQLiteStatement stmt, InLine entity) {
        stmt.clearBindings();
    ...
    @Override
    public InLine readEntity(Cursor cursor, int offset) {
        InLine entity = new InLine( //
            ...
            cursor.isNull(offset + 15) ? null : cursor.getString(offset + 15) // homearea
        );
        return entity;
    }
     
    @Override
    public void readEntity(Cursor cursor, InLine entity, int offset) {
        ...
        entity.setHomearea(cursor.isNull(offset + 15) ? null : cursor.getString(offset + 15));
     }
    
    @Override
    protected final Long updateKeyAfterInsert(InLine entity, long rowId) {
        entity.setBm(rowId);
        return rowId;
    }
    
    @Override
    public Long getKey(InLine entity) {
        if(entity != null) {
            return entity.getBm();
        } else {
            return null;
    ...
    @Override
    public boolean hasKey(InLine entity) {
